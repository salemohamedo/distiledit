...
from counterfact.py.counterfact import CounterFactDataset
from counterfact.tfidf.tfidf_stats import get_tfidf_vectorizer

from util import nethook

# All methods
from edit_algorithms.rome import ROMEHyperParams, apply_rome_to_model
from edit_algorithms.ft import FTHyperParams, apply_ft_to_model
from edit_algorithms.kn import KNHyperParams, apply_kn_to_model
from edit_algorithms.mend import MENDHyperParams, MendRewriteExecutor

# Evaluation tools
from eval_utils import compute_rewrite_quality
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name",
        choices=["gpt2-xl", "EleutherAI/gpt-j-6B", "distilgpt2"],
        default="gpt2-xl",
        help="Model to edit.",
    )
    parser.add_argument(
